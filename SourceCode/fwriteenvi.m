function fwriteenvi(image,fname)
% fwriteenvi           - write ENVI image from MATLAB array (V. Guissard, Apr 29 2004)
%
...
if fid == -1
    error('Could not create header file');
end
